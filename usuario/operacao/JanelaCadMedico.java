 ...
 * @author Usuário
 */
public class JanelaCadMedico extends javax.swing.JDialog {
    
    private ServidorClinica fachada;
    /**
     * Creates new form JanelaCadMedico
     */
    public JanelaCadMedico(ServidorClinica fachada) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cadastrar Médico");
    ...
    private void botaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastrarActionPerformed
        ...
        try {
            if (nome.trim().isEmpty() || cpf.trim().isEmpty() || campoData.equals("dd/mm/aaaa")
                ...
                JOptionPane.showMessageDialog(null,"CRM inválido!","Atenção",ERROR_MESSAGE);
                campoCRM.requestFocus();
            }else{
                ...
                if(resul == 0){
                    ...
                    try {
                        fachada.cadastrarMedico(crm, login, senha, nome, cpf, dataNasc);
                        JOptionPane.showMessageDialog(null,"Cadastro realizado com sucesso!","Cadastrado",INFORMATION_MESSAGE);
                        dispose();
                    } catch (LoginEmUsoException | MedicoJaExisteException ex) {
